...
UserVoice.Dialog = {
    ...
    setContent: function (html) {
        ...
        if (typeof(Prototype) != 'undefined') {
            ...
            //console.log( html );
            //html = '<iframe id="uservoice_dialog_iframe" src="http://thenounproject.uservoice.com/forums/90265/widgets/popin.html?lang=en&referer=http://localhost:8000/#" frameborder="0" scrolling="no" allowtransparency="true" width="350px" height="530px" style="height: 530px; width: 350px;"></iframe>'
            /* &&  */
            //html = 'http://thenounproject.uservoice.com/forums/90265/widgets/popin.html?lang=en&referer=http://localhost:8000/#';
            /* Escape the charactor to numeric entities. */
...
UserVoice.Util.includeCss(UserVoice.Util.render(UserVoice.Dialog.css_template, {
    background_image_url: UserVoice.Util.getAssetHost() + '/images/icons/close.png'
}));
if (!UserVoice) {
    var UserVoice = {};
}
